...
* **Never edit a `_template.md` or a `<type>.md`.** See *Template defects* below. Where the request is *about* one of
  ...
  [prc-sweep-prose](../../../../examples/dog-fooding/processes/sweep-prose.md), whose step 8 is the only one covering them.
...
1. **Establish scope, and count what is in it.** One record, a folder, or a named set. Asked to review "the corpus",
   ...
   [prc-sweep-prose](../../../../examples/dog-fooding/processes/sweep-prose.md) rather than here. **Test the claim the request makes.** "These are verbose" and
...
10. **Propose rather than commit.** Run [prc-pull-request](../../../../examples/dog-fooding/processes/pull-request.md) only if asked.
