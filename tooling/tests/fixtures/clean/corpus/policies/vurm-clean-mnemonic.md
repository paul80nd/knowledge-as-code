...
# A clean mnemonic policy

`Policy: pol-VURM` `DRAFT`

## Purpose

The happy path for a mnemonic id: `pol-VURM` upper-case in the frontmatter, `vurm-` lower-case in the filename, and
the two agreeing case-insensitively.
