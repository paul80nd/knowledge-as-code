...
Scenario: An empty section is reported, and the wording follows what the author can do about it
  ...
  Then the findings for "adrs/0011-headings-with-no-body.md" are exactly:
    | line | check         | message                                                                    |
    |   33 | empty-section | required section '## Consequences' has nothing under it.                   |
    |   35 | empty-section | section '## Related' has nothing under it. Write it or delete the heading. |
