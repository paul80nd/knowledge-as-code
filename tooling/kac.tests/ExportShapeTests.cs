...
public class ExportShapeTests
{
    private const string Pinned =
        ...
        data@2
          fields: id, title, status, owned-by, classification, personal-data, data-subjects, retention, region, flows-to, review-by, tags
          sections:
            Purpose: full
            Entities: full
            Where it lives: full
        ...
        integrations@2
          ...
          sections:
            ...
            Exit: full
        nfrs@5
          fields: id, title, status, characteristic, applies-to, target, window, alert-after, measured-by, constrained-by, agreed-on, review-by, tags
          sections:
            Target: full
        ...
        runbooks@2
          ...
          sections:
            ...
            Impact: full
        services@2
          fields: id, title, status, component-type, platform, criticality, monitoring-output, repos, interfaces, depends-on, data-stores, nfrs, facets, tags
          sections:
            What it does: full
            Where it lives: full
            Dependencies: full
