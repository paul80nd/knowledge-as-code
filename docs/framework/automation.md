...
**Does the record do what its tier asks?** Behaviour sets the rule, so the checks follow the tier. A standard cites
what it derives from. A procedural one records when it was last rehearsed. An
