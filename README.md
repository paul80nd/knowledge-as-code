...
|---|---|
| `example-libraries` | `0.9.1` |
| `example-engineering` | `0.22.2` |
| `example-payments` | `0.16.0` |
| `example-dogfooding` | `0.36.1` |

Built from [`8d1517ff3dee105f5ae703cf103fe43a167d0789`](https://github.com/paul80nd/knowledge-as-code/commit/8d1517ff3dee105f5ae703cf103fe43a167d0789).
