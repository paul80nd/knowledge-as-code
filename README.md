...
|-------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|--------------------------------------------------------|
| `kac validate` — 65 checks: the schema itself, frontmatter, identity, structure, clauses, links, graph reciprocity, type setup, type pages | Tiered corpora — governance above domain        | Published machine-readable corpus contracts            |
