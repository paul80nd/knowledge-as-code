...
| `example-payments` | `0.9.1` |
| `example-dogfooding` | `0.20.2` |

Built from [`adfb13c1da37b97a6ca01aff54df9e4e4a02ccbc`](https://github.com/paul80nd/knowledge-as-code/commit/adfb13c1da37b97a6ca01aff54df9e4e4a02ccbc).
