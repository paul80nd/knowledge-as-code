...
| `CONFIG`  | **MUST** hold environment-specific configuration outside the artifact, so the artifact promoted between environments is the one that was built     | [ISO 27001:2022].A.8.9                                                         |
