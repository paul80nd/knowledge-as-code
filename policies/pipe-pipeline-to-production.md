...
| `PROMOTE` | **MUST** deploy only artefacts the pipeline itself produced, promoting the same artefact through environments rather than rebuilding per stage     | [ISO 27001:2022].A.8.19, [NIST SSDF 1.1].PS.2                                  |
