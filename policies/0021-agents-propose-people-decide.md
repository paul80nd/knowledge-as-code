...
_Boundary: the identity an agent authenticates as is governed by [pol-0003](0003-access-by-identity.md) and the
credentials it holds by [pol-0004](0004-secrets-are-never-embedded.md). This policy is about the authority of what it
produces._
...
* We **will** hold agent-produced changes to every gate that applies to our own — the same review, the same automated
  verification under [pol-0007](0007-automated-verification.md), the same route to production.
...
* We **will not** hold an agent to a rule we never put within its reach — under
  [pol-0002](0002-knowledge-is-written-down.md) that is our failure, not the agent's.
...
[pol-0008](0008-pipeline-to-production.md) governs reconciling it afterwards.
