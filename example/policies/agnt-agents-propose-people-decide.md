...
[discovery](../discoveries). A discovery names its source, says how confident we are, and expires unless someone
confirms it. It cannot confirm itself. It becomes an [FAQ](../faqs) or a [standard](../standards) only when a person
promotes it. [adr-0001] records why, and says what we lose if that promotion step is skipped.
