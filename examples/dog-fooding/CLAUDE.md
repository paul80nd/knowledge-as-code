...
* **This corpus describes the repository it sits in.** Every other corpus here is fiction, where a record that is
  convenient is good enough. A record here names a real workflow file, binds a real pull request, or is followed by
  whoever is on the end of a red build. Check the claim against the repository before you write it down, and correct
  the record when the repository moves.
