...
give the steps, and this corpus records the rules a change has to meet. Somebody with no context can read any of it,
and agents do that every day.
...
* A session here reports where the guidance failed it, and that feedback keeps the writing honest.
...
Everything in this repository: the tool, the schema, the four corpora, the site and the workflows.

## Related

* [dev-standing-publish-rights] and [dev-decisions-live-in-commits] both depend on this condition.
