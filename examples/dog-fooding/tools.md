...
integration. Something we deploy is a [service](services.md).

The register records **current state**. An ADR records the **decision**, where there was one worth recording.
