...
and how it is reviewed. What is below is only what a discovery adds to that.
...
where you have a value for it, and leave it out where you do not. [The type page](../discoveries.md#metadata) says what
each one holds.
...
What you were doing when you hit it, and anything that might be relevant: branch, environment, version, time of day.
...
don't verify it first, and don't write it as a standard. If it turns out to be real, general and current,
a human promotes it and the polish happens then.)_
