...
| [Fix](../fixes.md)             | ITIL Problem Management, the *known error* construct                                                                                                                                                                                        | A problem whose cause is understood and whose fix is documented, and the observed → analysed → promoted lifecycle                                        | ITIL binds a known error to a formal problem record and an owning practice. Ours is promoted by any verification, from anything noticed                                                      |
