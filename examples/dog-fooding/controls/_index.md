...
| ctl-0009 | [Three test layers run before a merge](0009-tool-test-layers.md)                                  | ci        | per-pr    | eng:std-GATES, eng:std-TEST, std-PLUGIN | active |
| ctl-0010 | [The documentation site builds with no dead link](0010-docs-build.md)                             | ci        | per-pr    | eng:std-GATES                           | active |
| ctl-0011 | [Every corpus whose records changed has moved its content-version](0011-content-version-tests.md) | ci        | per-pr    | std-CI                                  | active |
