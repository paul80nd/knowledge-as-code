...
* **Retention rules as commitments.** A policy holds the commitment, and a data document records what the store actually
  does.
...
| `status` *†        | `active` `deprecated`                | Whether this data is current or deprecated. In force at `active`.                                                                                      |
