...
* **A rule**: "deployments happen in dependency order" is a standard. The release process cites it.
...
* **An explanation.** How the pipeline works is an explanation. How to use it is a process.
