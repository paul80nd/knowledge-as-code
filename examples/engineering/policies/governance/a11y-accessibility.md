...
| `REPORT`  | **MUST** provide a route for people outside the organisation to report an accessibility barrier, and respond when they do              |                                                                                             |
| `CURRENT` | **MUST** keep the accessibility statement current and truthful about the gaps that remain                                              |                                                                                             |
