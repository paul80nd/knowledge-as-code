...
| `RESTORE` | **MUST** test restoration at least quarterly                                                                                   | [ISO 27001:2022].A.8.13, [Azure WAF].reliability, [UK GDPR].Art.32(1)(d)  |
| `PROVEN`  | **MUST** retain the record of a restore test for at least 12 months                                                            | [ISO 27001:2022].A.8.13                                                   |
...
| `IMMUTE`  | **MUST** protect a backup from being overwritten or deleted within its retention window                                        | [ISO 27001:2022].A.8.13                                                   |
