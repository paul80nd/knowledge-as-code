...
| `CREDS`   | **MUST** keep production credentials and secrets unreachable from any lower environment. See [pol-SCRT]                               | [NIST SSDF 1.1].PO.5                          |
...
| `REUSE`   | **MUST NOT** reuse a production secret in any environment below production. See [pol-SCRT]                                            | [NIST SSDF 1.1].PO.5                          |
