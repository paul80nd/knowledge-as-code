...
| `LEDGER`  | **MUST** maintain an inventory of secrets and service accounts, naming what each is for and who owns it                                      | [ISO 27001:2022].A.5.17                          |
| `ENCRYPT` | **MUST** encrypt the secret store, and any transfer of a secret out of it                                                                    | [ISO 27001:2022].A.5.17                          |
...
| `APART`   | **MUST NOT** transfer an encryption key via the same channel as the data it protects                                                         | [ISO 27001:2022].A.8.24                          |
| `WATCH`   | SHOULD monitor privileged and service-account use for anomalies ([pol-OBSV].SECMON is the general case)                                      | [ISO 27001:2022].A.5.17                          |
...
[pol-OBSV]: ../operations/obsv-observability.md#clauses
