...
where you have a value for it, and leave it out where you do not. [The type page](../services.md#metadata) lists every
...
What this service owns, and where it stores it. Link the data document for the domain, which is where a schema is
described.
